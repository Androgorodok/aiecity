...
def report(
    ...
    title: str = typer.Option("Отчёт", help="Заголовок"),
    min_missing_share: float = typer.Option(0.7, help="Минимальный порог доли пропусков.")
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Наличие одинаковых user_id: **{quality_flags['has_suspicious_id_duplicates']}**\n")
        f.write(f"- Наличие одинаковых с одинаковыми значениями: **{quality_flags['has_constant_columns']}**\n")
